...
public class InicializerScript : MonoBehaviour {
    ...
    {
#if UNITY_ANDROID
        string appId = "ca-app-pub-8875687836686988~3037223195";
...
#elif UNITY_ANDROID
                    string adUnitId = "ca-app-pub-8875687836686988/5504663927";
#elif UNITY_IPHONE
    ...
    private void RequestInterstitial()
    {
        ...
        string adUnitId = "unused";
#elif UNITY_ANDROID
                    string adUnitId = "ca-app-pub-8875687836686988/8487293751";
#elif UNITY_IPHONE
                      //string adUnitId = "ca-app-pub-3940256099942544/2934735716";
#else
                  string adUnitId = "unexpected_platform";
